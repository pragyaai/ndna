...
<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(330px, 1fr)); gap: 24px; margin: 30px 0;">
  <div style="text-align: center;">
    <a href="assets/gifs/collapse/africa_dpo_rotation.gif" data-lightbox="gallery" data-title="Africa DPO Rotation">
      <img src="assets/gifs/collapse/africa_dpo_rotation.gif" alt="Africa DPO Rotation nDNA" style="max-width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.08);">
    </a>
  ...
  <div style="text-align: center;">
    <a href="assets/gifs/collapse/asia_dpo_rotation.gif" data-lightbox="gallery" data-title="Asia DPO Rotation">
      <img src="assets/gifs/collapse/asia_dpo_rotation.gif" alt="Asia DPO Rotation nDNA" style="max-width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.08);">
    </a>
  ...
  <div style="text-align: center;">
    <a href="assets/gifs/collapse/china_dpo_rotation.gif" data-lightbox="gallery" data-title="China DPO Rotation">
      <img src="assets/gifs/collapse/china_dpo_rotation.gif" alt="China DPO Rotation nDNA" style="max-width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.08);">
    </a>
  ...
  <div style="text-align: center;">
    <a href="assets/gifs/collapse/latinamerica_dpo_rotation.gif" data-lightbox="gallery" data-title="Latin America DPO Rotation">
      <img src="assets/gifs/collapse/latinamerica_dpo_rotation.gif" alt="Latin America DPO Rotation nDNA" style="max-width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.08);">
    </a>
  ...
  <div style="text-align: center;">
    <a href="assets/gifs/collapse/middleeast_dpo_rotation.gif" data-lightbox="gallery" data-title="Middle East DPO Rotation">
      <img src="assets/gifs/collapse/middleeast_dpo_rotation.gif" alt="Middle East DPO Rotation nDNA" style="max-width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.08);">
    </a>
  ...
  <div style="text-align: center;">
    <a href="assets/gifs/collapse/europe_dpo_rotation.gif" data-lightbox="gallery" data-title="Europe DPO Rotation">
      <img src="assets/gifs/collapse/europe_dpo_rotation.gif" alt="Europe DPO Rotation nDNA" style="max-width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.08);">
    </a>
  ...
  <div style="text-align: center;">
    <a href="assets/gifs/collapse/northamerica_dpo_rotation.gif" data-lightbox="gallery" data-title="North America DPO Rotation">
      <img src="assets/gifs/collapse/northamerica_dpo_rotation.gif" alt="North America DPO Rotation nDNA" style="max-width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.08);">
    </a>
  ...
  <div style="text-align: center;">
    <a href="assets/gifs/collapse/australia_dpo_rotation.gif" data-lightbox="gallery" data-title="Australia DPO Rotation">
      <img src="assets/gifs/collapse/australia_dpo_rotation.gif" alt="Australia DPO Rotation nDNA" style="max-width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.08);">
    </a>
  ...
  <div style="text-align: center;">
    <a href="assets/gifs/collapse/llama_dpo_rotation.gif" data-lightbox="gallery" data-title="LLaMA DPO Rotation">
      <img src="assets/gifs/collapse/llama_dpo_rotation.gif" alt="LLaMA DPO Rotation nDNA" style="max-width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.08);">
    </a>
