...
- **Spectral Curvature**
  ...
  \kappa_\ell
  $$
  Behavioral instability and reasoning path deviations

- **Thermodynamic Length**
  $$
  L_\ell
  $$
  Computational effort required for value integration

- **Belief Vector Strength**  
  Magnitude of alignment steering effects
