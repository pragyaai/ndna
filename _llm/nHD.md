...
<img src="{{ '/assets/figures/nhd_classical_vs_neural.png' | relative_url }}" style="width: 100%; max-width: 720px; display: block; margin: auto;" />

<div style="text-align: justify; font-size: 0.9em; margin-top: 0.8em;">
  <strong>Figure 2. Illustrating Classical vs Neural Hamming Distance (nHD):</strong>
  <br>
...
<img src="{{ '/assets/figures/ngdi_layerwise_fusion.png' | relative_url }}" style="width: 100%; max-width: 720px; display: block; margin: auto;" />

<div style="text-align: justify; font-size: 0.9em; margin-top: 0.8em;">
  <strong>Figure 3. Neural Genetic Dissimilarity in Layer-wise Fusion:</strong>
