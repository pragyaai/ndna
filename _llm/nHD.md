...
<div style="text-align: center;">
  ...
  <p style="text-align: left; font-size: 0.95em;">
    \\( \kappa_\ell: 0.3 \\rightarrow 0.7 \\), \\( L_\ell: 0.4 \\rightarrow 0.7 \\). Smooth geodesic interpolation within convex hull. Reflects semantic augmentation and representational folding.<br><br>
    \\[
