...
{% include ndna-title.liquid title="The nDNA Cartograph: Latent Semantic Genome of Foundation Models" %}
...
### Core Dimensions of Neural DNA Analysis
...
| **Layer** | **$$\kappa_\ell$$** | **$$\mathcal{L}_\ell$$** | **$$\lVert\mathbf{v}\rVert$$** | **Belief Vector** $$\mathbf{v}_\ell^{(c)}$$ |
|-----------|---------|---------|----------|--------------------------------|
...
**DNA:** $$\Sigma^3 / \ker \phi \to \mathcal{A}$$     **nDNA:** $$\mathcal{X} / G_{\text{LLM}} \to V/G$$
